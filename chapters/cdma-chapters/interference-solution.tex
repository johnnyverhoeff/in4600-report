...
%If the `ceil' or `round' function was used, the result could exceed $m$ and interference free decoding can only be guaranteed if the number of transmitters concurrently transmitting is equal or less than $m$.
