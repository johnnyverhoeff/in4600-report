...
With piggybacking on VLC, each light will get an unique ID, that they can transmit via VLC and the same ID will also be transmitted through the power they draw due to the modulation.
